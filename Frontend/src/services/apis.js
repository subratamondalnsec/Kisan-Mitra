...
export const CropDiseaseAPI = {
    GET_PREDICTION_HISTORY: BASE_URL + "crop-diseases/history",
    GET_PREDICTION_BY_ID: BASE_URL + "crop-diseases/prediction",
    CREATE_PREDICTION: BASE_URL + "crop-diseases/predict",
    DELETE_PREDICTION: BASE_URL + "crop-diseases/delete",
}

export const SoilHealthAPI = {
    TEST_SOIL_QUALITY: BASE_URL + "soil-health/test",
    GET_HISTORY: BASE_URL + "soil-health/history",
    DELETE_RECORD: BASE_URL + "soil-health/delete-soilHealthId",
}